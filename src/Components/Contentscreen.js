...
function Contentscreen(props) {
  ...
  return (
    <>
      ...
      <div>
        <div><embed className='xl:w-[50%] xl:h-[1250px] lg:w-[45%] lg:h-[1000px] md:w-[75%] md:h-[900px] sm:w-[75%] sm:h-[900px] w-[80%] h-[600px] inset-0 m-auto xl:mt-[5%] lg:mt-[5%] md:mt-[5%] sm:mt-[5%] mt-[10%] z-20' src={props.q_data+"#toolbar=0"} />
        </div>
      </div>
    </>
  )
